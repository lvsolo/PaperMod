...
class DataAugmentationDINO:
    ...
    def __init__(self, global_crops_scale, local_crops_scale, local_crops_number,
        ...
        # 2 个 global crop: 大尺度裁剪 -> 颜色抖动 -> 模糊 (再加 solarization)
        self.global_transfo1 = transforms.Compose([
            transforms.RandomResizedCrop(self.size_global, scale=self.global_crops_scale,
        ...
        # N 个 local crop: 小尺度裁剪 -> 颜色抖动 -> 模糊
        self.local_transfo = transforms.Compose([
            transforms.RandomResizedCrop(self.size_local, scale=self.local_crops_scale,
                                         interpolation=IM.BICUBIC),
